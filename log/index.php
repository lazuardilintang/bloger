 ...
 -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?php echo URL ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        class="fa-sm text-white-50"></i>halaman blog</a>
                    </div>
                    <div class='alert alert-primary' role='alert'>
             <p class="text-center">mohon maaf, ada beberapa fitur yang tidak bisa digunakan dan masih dalam tahap pengembangan.<br>
             trimakasih dan mohon maaf</p>
        </div>
                    <!-- Content Row -->
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            if ($pangkat == "admin") {
                                                $cek = mysqli_query($kon,"SELECT *from artikel");
                                                $hitung = mysqli_num_rows($cek);
                                            }
                                            else if($pangkat == "penulis"){
                                                $cek = mysqli_query($kon,"SELECT *FROM artikel WHERE penulis = '$penulis' ");
                                                $hitung = mysqli_num_rows($cek);
                                            }
                                            
                                            ?>
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">jumlah artikel
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $hitung ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
