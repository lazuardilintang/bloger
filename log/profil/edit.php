...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            ?>
            <button class="x3 d-sm-inline-block btn btn-sm btn-primary shadow-sm" name="edit">Kirim Edit Profil</button>
        </div>
    </div>
    <?php foreach ($cek as $ambil): ?>    
        <div class="card-body">
            <div class="row">
                <input type="hidden" name="id" value="<?php echo $ambil['id'] ?>" >
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <label>Nama : </label>
                                    <input type="text" class="form-control" name="nama" value="<?php echo $ambil['nama'] ?>">
                                </div>
                                <div class="card-body">
                                    <label>Email : </label>
                                    <input type="text" class="form-control" name="email" value="<?php echo $ambil['email'] ?>">
                                </div>
                                <div class="card-body">
                                    <label>Penulis : </label>
                                   <input type="text" class="form-control" name="penulis" value="<?php echo $ambil['penulis'] ?>">
                                </div>
                                <div class="card-body">
                                    <label>Tentang : </label><br>
                                    <textarea name="tentang" class="form-control" cols="50" rows="10"><?php echo nl2br($ambil['tentang']) ?></textarea>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                        <input type="file" name="foto" class="form-control" id="file" onchange="return fileValidation()">
    ...
    if(!allowedExtensions.exec(filePath)){
        ...
        if (fileInput.files && fileInput.files[0]) {
            ...
            reader.onload = function(e) {
                document.getElementById('imagePreview').innerHTML = '<img style="margon:5px;" width="100%" src="'+e.target.result+'"/>';
            };
