    ...
    <form method="post">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <input type="text" name="judul" value="<?php echo $aksi['judul'] ?>" class="form-control" id="judul" aria-describedby="judul">
                <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
            </div>
            </div>
            <div class="col-sm-12">
                <label>isi</label>
                <textarea class="ckeditor" name="isi" id="editor-full" ><?php echo $aksi['isi'] ?></textarea>
            </div>
        </div>
            <?php if ($halaman == 'artikel'): ?>
                <button name="editartikel" class="edit">edit artikel</button>
            <?php elseif ($halaman == 'draft'): ?>
                <button name="editdraft" class="tambah">edit draft</button>
                <button name="tambah" class="tambah">publish</button>
            <?php else: ?>
                <script>
                    document.location.href = 'index.php';
                </script>
