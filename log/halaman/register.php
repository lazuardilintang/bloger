                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" name="penulis" class="form-control form-control-user" id="penulis"
                                ...
                                <div class="form-group row">
                                    ...
                                    <button name="regis" class="btn btn-primary btn-user btn-block">Register Account</button>
                                <hr>
