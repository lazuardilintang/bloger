    ...
    $penulis = $ambil['penulis'];
     ...
     if (isset($_POST['tambah'])) {
         if (tambahkan($_POST)>0) {
             ...
             ";
             header("location:".BASE_URL."artikel?halaman=artikel");
         }else{
            echo "
                 <script>
             ...
             ";
             header("location:".BASE_URL."tambah");
         }
     }
     elseif (isset($_POST['draft'])) {
         if (draft($_POST)>0) {
             ...
             ";
             header("location:".BASE_URL."artikel?halaman=draft");
         }else{
            echo "
                 <script>
                alert('data gagal ditambahkan!');
    ...
    <form method="post">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                <div class="container">
                <label>isi</label>
                <textarea id="rich-editor" name="isi"></textarea>
                </div>
            </div>
        </div>
            <button name="tambah" class="tambah"  onclick="return confirm('apakah sudah anda back up di folder pribadi ??');" >publish</button>
            <button name="draft" class="tambah"  onclick="return confirm('apakah sudah anda back up di folder pribadi ??');" >draft</button>
    </form>
</div>
